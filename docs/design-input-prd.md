...
| 用户 | 典型任务 | 核心诉求 |
| --- | --- | --- |
| QA | 评审前准备、findings 复盘、自查计划准备 | 快速看见证据缺口和优先自查主题 |
| RA | 注册资料或技术文件预检查 | 确认来源、证据和需人工复核的表述 |
...
在正式评审、注册提交准备或质量自查会议前，用户进入一个本地项目工作区，查看项目资料被系统识别出的证据状态、证据缺口和自查计划候选，并决定哪些建议需要接受、修改、驳回或补充证据。
...
| DI-04 | 系统将证据关联到要求、控制、证据和缺口 | P0 |
| DI-05 | 系统生成 evidence gap focus 和 checklist candidate | P0 |
...
- 用户能在 3-5 分钟内理解当前项目的主要证据缺口和优先关注主题。
- 用户能看懂至少一条“要求 -> 控制 -> 证据 -> 缺口”的来源链路。
...
- 每个缺口或建议都能进入解释视图。
- 关键动作清晰：接受、修改、驳回、补证据。
- coverage、confidence、gap priority 不被表现成合规评分。
